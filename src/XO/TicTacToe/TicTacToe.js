...
import x2 from '../Assets/x3.png';
import o2 from '../Assets/o3.png';
...
const TicTacToe = () => {
    ...
    // Verrouille le plateau après une victoire pour empêcher d'autres actions.
    ...
    //Détermine quel symbole placer en fonction de Count (pair → "x", impair → "o").
    const toggle = (e, num) => {
        if (Lock) {
            return 0;
        }
        if (Count % 2 === 0) {
            e.target.innerHTML = `<img src='${x2}'>`;
            data[num] = "x";
            setCount(++Count);
        } else {
            e.target.innerHTML = `<img src='${o2}'>`;
            data[num] = "o";
            setCount(++Count);
        }
        checkWin();
    ...
    const checkWin = () => {
        ...
        //Si toutes les cases sont remplies et qu'il n'y a pas de gagnant retourn match null
    ...
    return (
        <div className='tic-container'>
            <h1 className='title' ref={titleref}>Tic Tac Toe  <span > ASTRONAUT</span></h1>
            <div className='board'>
                <div className='row1'>
